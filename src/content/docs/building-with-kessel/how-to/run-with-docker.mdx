...
2. **Start all services.**
    ...
    - Downloads the SpiceDB schema from the [stage rbac-config repo](https://github.com/project-kessel/rbac-config)
...
For API and gRPC errors (status codes, messages, and fixes), see the [Error codes](/building-with-kessel/reference/error-codes/) reference.
