...
Kessel uses [JSON Schema (Draft 07)](https://json-schema.org/draft-07/schema) to define resource types and representations. JSON Schema is a standard vocabulary for describing JSON data structures, including:
