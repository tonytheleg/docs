...
| Method | Consistency | Caller control | Use when |
|--------|-------------|----------------|----------|
| `Check` | Caller's choice (default: `minimize_latency`) | Full | Reading, browsing, listing |
| `CheckForUpdate` | Always fully consistent | None | Before modifying or deleting a resource |
